...
- Busiest commit hour is **1 AM KST** with **689** commits; **29%** of activity lands between midnight and 5 AM.
...
- Readability profile is deliberate: roughly **16.5** comment lines and **12.5** blank lines per 100 lines of code.
