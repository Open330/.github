...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/lines%20of%20code-1%2C114%2C753-orange?style=flat-square" alt="LOC">
</p>
...
|--------|-------|--------:|------:|
| 🌙 Night | 12–5 AM | 4592 | 30% |
| ☀️ Morning | 6–11 AM | 4436 | 29% |
| 🌤️ Afternoon | 12–5 PM | 2416 | 16% |
| 🌆 Evening | 6–11 PM | 3944 | 26% |
...
| Swift | 1,861 | 434,549 | 60,661 | 63,937 |
| Rust | 207 | 93,502 | 13,009 | 8,984 |
| Python | 121 | 29,731 | 2,447 | 2,928 |
| Shell | 85 | 9,668 | 2,103 | 1,510 |
...
| Java | 1 | 17 | 0 | 1 |
| JSONC | 1 | 10 | 0 | 0 |
| **Total** | **5,735** | **1,114,753** | **180,598** | **131,914** |
...
- Busiest commit hour is **1 AM KST** with **941** commits; **30%** of activity lands between midnight and 5 AM.
- Language concentration is high: **TypeScript** leads with **53%** of tracked bytes, and the top 3 languages make up **95%**.
- Product surface is web-forward: TypeScript/JavaScript/CSS/HTML account for **47%** of code LOC.
- Tooling and systems depth is substantial: Rust + shell-focused languages account for **9%** of code LOC.
- Readability profile is deliberate: roughly **16.2** comment lines and **11.8** blank lines per 100 lines of code.
...
|---|---|---:|---|
| <a href="https://github.com/hletrd"><img src="https://avatars.githubusercontent.com/u/9067894?v=4&s=40" width="40" height="40" alt="hletrd"></a> | [@hletrd](https://github.com/hletrd) | 8,297,628 | `████████████████████` |
...
| <a href="https://github.com/circle-oo"><img src="https://avatars.githubusercontent.com/u/9482404?v=4&s=40" width="40" height="40" alt="circle-oo"></a> | [@circle-oo](https://github.com/circle-oo) | 10,383 | `█░░░░░░░░░░░░░░░░░░░` |
